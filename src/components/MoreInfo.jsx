...
const MoreInfo = () => {
  ...
  // fetch the data in the spreadsheet so as to extract the user mission perstective

  useEffect(() => {
    fetch("https://sheet.best/api/sheets/641f08eb-2291-4c17-a430-ce3d4d8dbb13")
      .then((res) => res.json())
      .then((data) => {
        setRenting(data);
      })
  ...
  const handleSubmit = (e) => {
    ...
    if (client.name === "" || client.email == "") {
      ...
      setIsLoading(true);
      fetch(
        "https://sheet.best/api/sheets/641f08eb-2291-4c17-a430-ce3d4d8dbb13",
        {
          method: "POST",
          mode: "cors",
          headers: {
